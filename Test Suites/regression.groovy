...
def setUp() {
	println("Este mensaje es del setupSuitCase")
}
...
def tearDown() {
	println("Este mensaje es del tearDownSuitCase")
}
...
def setupTestCase() {
	println("Este mensaje es del setupTestCase")
}
...
def tearDownTestCase() {
	println("Este mensaje es del tearDownTestCase")
}
